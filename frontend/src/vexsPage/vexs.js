...
const VEXsPage = () => {
  ...
  useEffect(() => {
    ...
    const fetch_vexs = () => {
      fetch(`${process.env.REACT_APP_API_URL}/api/vex/user/${user_id}`, {
        method: 'GET',
        headers: {
  ...
  const on_button_generate_vex = () => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/api/vex/generate`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const download_vex = (vex_id) => {
    fetch(`${process.env.REACT_APP_API_URL}/api/vex/download/${vex_id}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
